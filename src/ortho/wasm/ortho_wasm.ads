...
--  ortho_nodes.common.ads and ortho_wasm.private.ads
--
--  WASM back-end for ortho.
--  Used by the Makefile to generate ortho_wasm.ads.
--  Copyright (C) 2024 VHDL.AI Academy contributors
--  Licensed under GPL-2.0-or-later.
--
--  Structure mirrors ortho_mcode.private.ads:
--   - Everything before "private" becomes the package header
--     in the generated .ads
